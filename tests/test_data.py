import os
import unittest
from stestdata import sensors, TestData
...
class Test(unittest.TestCase):
    ...
    def test_list_sensors(self):
        self.assertEquals(sensors(), ['landsat8', 'sentinel2'])
    ...
    def test_sensor_path(self):
        ...
        self.assertEquals(t.examples['small_full_data_cloudy']['B1']['filename'], 'l8_B1.tif')
